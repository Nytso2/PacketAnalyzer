#############################################################################
# Makefile for building: PacketAnalyzer
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  PacketAnalyzer.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile PacketAnalyzer.pro
#############################################################################
...
CXXFLAGS      = -pipe -Wall -Wextra -O2 -std=gnu++1z -Wall -Wextra -fPIC -D_REENTRANT $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PacketAnalyzer1.0.0
DISTDIR = /home/luis/Desktop/PacketAnalyzer-main/.tmp/PacketAnalyzer1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		PacketAnalyzer.pro  main.cpp
QMAKE_TARGET  = PacketAnalyzer
DESTDIR       = 
...
PacketAnalyzer:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: PacketAnalyzer.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile PacketAnalyzer.pro
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp
	g++ -pipe -Wall -Wextra -O2 -std=gnu++1z -Wall -Wextra -fPIC -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp
...
main.moc: main.cpp \
	...
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/luis/Desktop/PacketAnalyzer-main/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/luis/Desktop/PacketAnalyzer-main -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include main.cpp -o main.moc
